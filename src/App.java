...
public class App {
   ...
   public static String employees = "src\\Employees.txt";
   ...
   for(int i=0; i<110; i++) {//Finds words 
    ...
    File vfile1 = new File(transactionFile);
    ...
    try {
      FileWriter ttom = new FileWriter(reportFile);
      ttom.write(
      ...
      ttom.close();
      System.out.println("Report File Made");
    }
    catch(IOException e) {
      e.printStackTrace();
    }

    File vfile2= new File(reportFile);
